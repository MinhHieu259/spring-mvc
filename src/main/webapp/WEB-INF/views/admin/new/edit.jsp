	...
	$('#btnAddOrUpdateNew').click(function (e) {
		...
		function addNew(data) {
			$.ajax({
				...
				success : function(result) {
					window.location.href = "${NewURL}?type=edit&id="+result.id+"&message=Thêm_Thành_Công";
				},
				error : function(error) {
					window.location.href = "${NewURL}?type=list&maxPageItem=2&page=1&message=Lỗi_Hệ_Thống";
				}
			});
		}
		function updateNew(data) {
			$.ajax({
				...
				dataType : 'json',
				success : function(result) {
					window.location.href = "${NewURL}?type=edit&id="+result.id+"&message=Cập_Nhật_Thành_Công";
				},
				error : function(error) {
					window.location.href = "${NewURL}?type=list&maxPageItem=2&page=1&message=Lỗi_Hệ_Thống";
				}
